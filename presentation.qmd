...
:::: {.r-hstack}
::: {data-id="box1" style="background: #040204; width: 120px; height: 15px; margin: 0px;"}
:::

::: {data-id="box2" style="background: #ff5b7f; width: 550px; height: 15px; margin: 0px;"}
:::

::: {data-id="box3" style="background: #ffffffff; width: 120px; height: 15px; margin: 0px;"}
:::

::: {data-id="box3" style="background: #7e1f86; width: 120px; height: 15px; margin: 0px;"}
:::
::::
...
::: {.text-right .text-color-black .text-font-roboto .text-size-body}
